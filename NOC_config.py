...
def rsdp_pw_create(bsr01, bsr02):
    ...
    if s1 != False and s2 != False:
        ...
        if slct == 'y':
            ...
            cfg2 = ja2.cfg_render("radio_sdp_pw_create/bsr02.cfg", sdp=sdp, b_bsa=b_bsa, b_bsa_ipb=b_bsa_ipb, bin_port1=bin_port2)
            ...
            if a_bsa == b_bsa:
                ...
                print(f'{bc.GREEN}[!]{bc.ENDC} == На BSA-{a_bsa} настроено ==')
                cfg4 = ja2.cfg_render("radio_sdp_pw_create/bsa-bkp.cfg", a_bsa=a_bsa, a_bsa_ipb=a_bsa_ipb, ring=ring)
